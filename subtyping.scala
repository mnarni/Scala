...
object subtyping:
  ...
  class Counter2 extends Counter {
    	private var count = 0;
    	override def decrement () = { count = count + 1}
    	override def increment () = { count = count + 1 }
    	override def get () : Int = count
  }  
  ...
  def observeCounterArray(f: Array[Counter] => Unit): Array[Int] =
    ...
    val c3 = new Counter2();
    f(Array(c1,c2,c3));
    var c : Array[Int] = Array(c1.get(), c2.get(), c3.get());
    c;
